...
const Sidebar = (props) => {
  ...
  const sidebarNavItems = [
    { display: 'Home', icon: <i className='bx bx-home'></i>, to: '/home', section: '' },
    { display: 'Adicionar', icon: <i className='bx bx-star'></i>, to: '/home/new', section: 'new' },
    { display: 'Configuração', icon: <i className='bx bx-user'></i>, to: '/home/config', section: 'user' },
  ];
